...
def contabiliza_totais(nums, lista_total):
    ...
    for i in range(len(nums)):
        ...
        for i_cat in range(num_cat):
            ...
            #Checa em qual faixa/categoria o numero está com base nesses limites
...
def draw(screen):
    ...
    for i in range(len(lista_total)):
        x = 100 + i * 50
        h= 20 * lista_total[1]
        pygame.draw.rect(screen, (255, 0 ,0), (x, screen_h - h, 25, h))
        #pygame.draw.rect(screen, (255, 0, 0), (x, 0, 25, h))

lista_nums=[100.120,130,120,150,100,160,200,190,110,115,125,135,#170,130
            ]
